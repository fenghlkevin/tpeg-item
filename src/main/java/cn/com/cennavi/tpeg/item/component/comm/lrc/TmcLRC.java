...
// */
//@CoderLinks(compileOrder = @EncoderBuildOrder(order = { BaseComponent.ID, TmcLRC.TMCLOCATIONREFERENCE, BaseComponent.LENGTHATTR, BaseComponent.LENGTHCOMP }), buildOrder = @EncoderBuildOrder(order = {
//		BaseComponent.ID, BaseComponent.LENGTHCOMP, BaseComponent.LENGTHATTR, TmcLRC.TMCLOCATIONREFERENCE }))
//public class TmcLRC extends LRC {
//	
//	public TmcLRC(int a){}
//
...
//
//	@CoderItem(id = TmcLRC.TMCLOCATIONREFERENCE, type = CoderItemType.ITEM, length = 0)
...
//	 * 1~5bytes变长
//	 */
//	@CoderItem(id = BaseComponent.LENGTHCOMP, type = CoderItemType.LENGTH, dependent = @Dependent(dependentField = { BaseComponent.LENGTHATTR, TmcLRC.TMCLOCATIONREFERENCE }), length = -5)
